// Use for a second Toggle List on one page.
...
document.write("<link href=\"javascript/TJK_ToggleDL/TJK_ToggleDL.css\" type=\"text/css\" rel=\"stylesheet\" />")
document.write("<link href=\"javascript/TJK_ToggleDL/TJK_ToggleDL_ie5mac.css\" type=\"text/css\" rel=\"stylesheet\" />")
document.write("<!--[if lte IE 6]><link rel=\"stylesheet\" type=\"text/css\" href=\"javascript/TJK_ToggleDL/ielegacy_TJKToggle.css\" /><![endif]-->")
}
...
function TJK_ToggleDLopen2(){//we open all of them
	var zDD=document.getElementById('TJK_DL2').getElementsByTagName('dd');
	var zDT=document.getElementById('TJK_DL2').getElementsByTagName('dt');	
...
function TJK_ToggleDLclose2(){//we close all of them	
	var zDD=document.getElementById('TJK_DL2').getElementsByTagName('dd');
	var zDT=document.getElementById('TJK_DL2').getElementsByTagName('dt');	
	for(var i=0;i<zDT.length;i++){
...
function TJK_ToggleDL2(){
if (document.getElementById && document.getElementsByTagName){			
	var zDT=document.getElementById('TJK_DL2').getElementsByTagName('dt');
	var zDD=document.getElementById('TJK_DL2').getElementsByTagName('dd');
	var ToggleON = document.getElementById('TJK_ToggleON2');
	var ToggleOFF = document.getElementById('TJK_ToggleOFF2');	
